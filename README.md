...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/anibale11/oh-my-bash/master/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/anibale11/oh-my-bash/master/tools/install.sh -O -)"
```
